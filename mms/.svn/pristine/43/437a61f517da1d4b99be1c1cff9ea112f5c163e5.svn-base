...
{
	private static final String _CONFIG_FILE = "config.properties";
	...
	public HashMap<String,String> _para_hash;
	...
	*/
	...
	{
		if (line == null ) { return; }
		if (_para_hash == null) { _para_hash = new HashMap<String,String>(); }
