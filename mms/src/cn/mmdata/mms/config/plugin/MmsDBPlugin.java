...
public class MmsDBPlugin {
	public static void addPlugin(Plugins me) {
		...
		activeRecord.addMapping("hostdetail", HostDetail.class);
		activeRecord.addMapping("stat_rule_data", HostDetail.class);
		activeRecord.addMapping("stat_rule_users_h", HostDetail.class);
		activeRecord.addMapping("stat_rule_users_w", HostDetail.class);
